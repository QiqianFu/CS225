...
namespace cs225 {
  ...
  public:
    ...
    void paste(PNG* the_tile, int startX, int startY, int resolution);
    PNG* generateResizedImage(int startX, int startY, int resolution);
    HSLAPixel getScaledPixelDouble(double startX, double endX, double startY, double endY) const;
    HSLAPixel getScaledPixelInt(int startXint, int endXint,int startYint, int endYint) const;
